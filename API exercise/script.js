const app = {
  ...
  ending: function() {
    ...
    $('.fourthLine').append("or <a href='https://twitter.com/MarsCuriosity?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor'>learn</a>what Curiosity is doing today");
    $('.fifthLine').text("Soon Preserverance, a new Rover, will be joining Curioisty ");
  },

  rover: function() {
var number = [2,4,8, 12, 30];
